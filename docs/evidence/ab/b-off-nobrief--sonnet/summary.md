...
Test Files  7 passed (7)
      Tests  26 passed (26)
   Start at  11:42:07
   Duration  157ms (transform 56%, import 24%, tests 16%, worker 4%)
```

---

Сирий транскрипт: `docs/evidence/raw-transcripts.tar` → `docs/evidence/ab/b-off-nobrief--sonnet/transcript*.jsonl.gz`
